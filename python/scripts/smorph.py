...
v3 = ( 16, 16, baselvl )
v4 = ( 16, (-16 ), baselvl )
base = irit.poly( irit.list( v1, v2, v3, v4 ), irit.FALSE )
irit.color( base, irit.RED )
irit.attrib( base, "rgb", irit.GenStrObject("244,164,96" ))
irit.attrib( base, "texture", irit.GenStrObject("wood" ))
irit.attrib( base, "reflect", irit.GenStrObject("0.3" ))

wall1 = irit.poly( irit.list( ( basexymin, 16, baselvl ), ( basexymin, basexymin, baselvl ), ( basexymin, basexymin, 16 ), ( basexymin, 16, 16 ) ), irit.FALSE )
wall2 = irit.poly( irit.list( ( 16, basexymin, baselvl ), ( basexymin, basexymin, baselvl ), ( basexymin, basexymin, 16 ), ( 16, basexymin, 16 ) ), irit.FALSE )
...
i = 0
while ( i <= 11 ):
    msrf = irit.smorph( srf2, srf3, i/11 )
    irit.color( msrf, irit.WHITE )
    irit.attrib( msrf, "rgb", irit.GenStrObject("255,255,255" ))
    irit.attrib( msrf, "reflect", irit.GenRealObject(1 ))
    irit.attrib( msrf, "transp", irit.GenRealObject(0.95 ))
    irit.attrib( msrf, "index", irit.GenRealObject(1.4 ))
    irit.save( "morp2-" + str(i), irit.list( msrf, backgrd ) )
    i = i + 1
...
i = 0
while ( i <= 11 ):
    msrf = irit.smorph( srf3, srf4, i/11 )
    irit.color( msrf, irit.WHITE )
    irit.attrib( msrf, "rgb", irit.GenStrObject("255,255,255" ))
    irit.attrib( msrf, "reflect", irit.GenRealObject(1 ))
    irit.attrib( msrf, "transp", irit.GenRealObject(0.95 ))
    irit.attrib( msrf, "index", irit.GenRealObject(1.4 ))
    irit.save( "morp3-" + str(i), irit.list( msrf, backgrd ) )
    i = i + 1
...
i = 0
while ( i <= 11 ):
    msrf = irit.smorph( srf4, srf1, i/11 )
    irit.color( msrf, irit.WHITE )
    irit.attrib( msrf, "rgb", irit.GenStrObject("255,255,255" ))
    irit.attrib( msrf, "reflect", irit.GenRealObject(1 ))
    irit.attrib( msrf, "transp", irit.GenRealObject(0.95 ))
    irit.attrib( msrf, "index", irit.GenRealObject(1.4 ))
    irit.save( "morp4-" + str(i), irit.list( msrf, backgrd ) )
    i = i + 1
