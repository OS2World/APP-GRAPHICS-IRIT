...
IRIT_STATIC_DATA char
    *VersionStr = "Irit		Version 10a, Gershon Elber,\n\
	(C) Copyright 1989-2008 Gershon Elber, Non commercial use only.";
#else
IRIT_STATIC_DATA char
...
#elif NO_CONCAT_STR
     "(C) Copyright 1989-2008 Gershon Elber,  Unix  Version 10a";
#else
...
#   endif /* __UNIX__ */
    ...
    printf("#This is an IRIT script and as such requires both math and irit import:\n#\nimport math\nimport irit\n#\n\n");
