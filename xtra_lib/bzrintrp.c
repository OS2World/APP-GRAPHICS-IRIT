...
/*
 * bzrintrp.c:
 *   Bezier curve interpolation routines. From Graphics Gems 3.
 */

/*****************************************************************************
* AUXILIARY:								     *
* The following arrays were created by symbolically solving the bezier       *
* interpolant problem for orders 2 to 9. Each line holds the weights for     *
* the given points to interpolate at node values (i/k, k is the degree)      *
* as the i'th element divided by the zero element in line.		     *
*****************************************************************************/
IRIT_STATIC_DATA long IB2[2][3] =
{
    {       1L,       1L,       0L },
    {       1L,       0L,       1L }
};
IRIT_STATIC_DATA long *InterpBlend2[2] =
{
    IB2[0], IB2[1]
};

IRIT_STATIC_DATA long IB3[3][4] =
{
    {       1L,       1L,       0L,       0L },
    {       2L,      -1L,       4L,      -1L },
    {       1L,       0L,       0L,       1L }
};
IRIT_STATIC_DATA long *InterpBlend3[3] =
{
    IB3[0], IB3[1], IB3[2]
};

IRIT_STATIC_DATA long IB4[4][5] =
{
    {       1L,       1L,       0L,       0L,       0L },
    {       6L,      -5L,      18L,      -9L,       2L },
    {       6L,       2L,      -9L,      18L,      -5L },
...
IRIT_STATIC_DATA long *InterpBlend4[4] =
{
    IB4[0], IB4[1], IB4[2], IB4[3]
};

IRIT_STATIC_DATA long IB5[5][6] =
{
    {       1L,       1L,       0L,       0L,       0L,       0L },
...
IRIT_STATIC_DATA long *InterpBlend5[5] =
{
    IB5[0], IB5[1], IB5[2], IB5[3], IB5[4]
};

IRIT_STATIC_DATA long IB6[6][7] =
{
...
IRIT_STATIC_DATA long *InterpBlend6[6] =
{
    IB6[0], IB6[1], IB6[2], IB6[3], IB6[4], IB6[5]
};

IRIT_STATIC_DATA long IB7[7][8] =
{
    {       1L,       1L,       0L,       0L,       0L,       0L,       0L,
                                                                        0L },
...
IRIT_STATIC_DATA long *InterpBlend7[7] =
{
    IB7[0], IB7[1], IB7[2], IB7[3], IB7[4], IB7[5], IB7[6]
};

IRIT_STATIC_DATA long IB8[8][9] =
{
    {       1L,       1L,       0L,       0L,       0L,       0L,       0L,
                                                              0L,       0L },
...
IRIT_STATIC_DATA long *InterpBlend8[8] =
{
    IB8[0], IB8[1], IB8[2], IB8[3], IB8[4], IB8[5], IB8[6], IB8[7]
};

IRIT_STATIC_DATA long IB9[9][10] =
{
    {       1L,       1L,       0L,       0L,       0L,       0L,       0L,
                                                    0L,       0L,       0L },
...
IRIT_STATIC_DATA long *InterpBlend9[9] =
{
    IB9[0], IB9[1], IB9[2], IB9[3], IB9[4], IB9[5], IB9[6], IB9[7], IB9[8]
};

IRIT_STATIC_DATA long **InterpBlend[] =
{
    NULL,
    NULL,
    InterpBlend2,
...
/*****************************************************************************
* DESCRIPTION:                                                               *
* Blends one point using Input and Interp arrays.                            *
*                                                                            *
* PARAMETERS:                                                                *
*   Input:    Points to interpolate at node parameter values.                *
*   Interp:   One raw from the above matrix of size Size.                    *
*   Size:     Size of control polygon which is same as matrix size.          *
*                                                                            *
* RETURN VALUE:                                                              *
*   IrtRType: The interpolated control point.                                *
*****************************************************************************/
static IrtRType BzrCrvInterpOnePoint(IrtRType *Input, long *Interp, int Size)
{
    int i;
    long
	Denom = *Interp++;
    ...
    for (i = 0; i < Size; i++)
        R += (*Input++ * (IrtRType) (*Interp++)) / ((IrtRType) Denom);
...
/*****************************************************************************
* DESCRIPTION:                                                               M
* Blends the input points using the Interp array and puts the resulted       M
* blended point in Result array. Input and Result array are of size Size.    M
*                                                                            *
* PARAMETERS:                                                                M
*   Result:   Where the interpolated control points will be placed.          M
*   Input:    Points to interpolate at node parameter values.                M
*   Size:     Of control polygon.                                            M
*                                                                            *
* RETURN VALUE:                                                              M
*   void                                                                     M
*                                                                            *
* KEYWORDS:                                                                  M
*   BzrCrvInterp, interpolation                                              M
*****************************************************************************/
