...
OBJS = 	bsc_geom.o ctrl-brk.o dosintr.o freefrm1.o freefrm2.o freefrm3.o \
	...
	irit.o irit_db.o irit_io.o objects1.o objects2.o overload.o support.o

all:	irit

irit:	$(OBJS)
	slink from lib:c.o $(OBJS) to irit sc $(SYMS) lib $(IRIT_LIBS) $(IRIT_MORE_LIBS)\
$(MATHLIB) lib:scnb.lib

install: irit
	mv -f irit $(IRIT_BIN_DIR)
	cp iritinit.irt $(IRIT_BIN_DIR)
	cp iritfont.itd $(IRIT_BIN_DIR)
	cp irit-unx.cfg $(IRIT_BIN_DIR)/irit.cfg	# sic!
