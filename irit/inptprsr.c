...
/*****************************************************************************
* DESCRIPTION:                                                               M
*   Verify all function tables are intact.                                   M
*                                                                            *
* PARAMETERS:                                                                M
*   None                                                                     M
*                                                                            *
...
*                                                                            *
* KEYWORDS:                                                                  M
*   InputTestFuncTablesValidity                                              M
*****************************************************************************/
void InputTestFuncTablesValidity(void)
{
    assert(NumFuncTableSize < IP_NUM_FUNC_END - IP_NUM_FUNC);
    assert(ObjFuncTableSize < IP_OBJ_FUNC_END - IP_OBJ_FUNC1);
    assert(GenFuncTableSize < IP_GEN_FUNC_END - IP_GEN_FUNC);
}
